...
#define B40_RXD_PIN			-1				//蓝牙输入引脚
#define B40_TXD_PIN			-1				//蓝牙输入引脚
#define B40_RESET_CTRL		-1				//蓝牙复位
#define B40_TS_SW_CTRL		-1				//蓝牙透传模式切换
#define B40_CONET_STATUS	-1				//蓝牙连接状态指示
#define B40_SLEEP_CTRL  	GET_PIN(A, 8)	//蓝牙睡眠状态控制
#define B40_SLEEP_STATUS	GET_PIN(C, 9)	//蓝牙睡眠状态指示
